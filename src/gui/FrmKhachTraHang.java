...
//            //******** load Thong tin hoa don
    ...
    public void loadDataHDTraHang() throws RemoteException {
        ...
        for (HoaDonHoanTra hdht : dsHD) {
            ...
            if (hddh != null) {
                dm.addRow(new Object[]{stt, hd.getMaHoaDon(), hdht.getMaHoaDonHoanTra(), hddh.getMaHoaDonDoi(), formatter.format(hdht.getNgayHoanTra()), kh.getTenKhachHang(), trangThai, deciFormat.format(hdht.getTienHoanTra()-hddh.getTienHoanTra())});
                stt++;
            } else {
                dm.addRow(new Object[]{stt, hd.getMaHoaDon(), hdht.getMaHoaDonHoanTra(), "", formatter.format(hdht.getNgayHoanTra()), kh.getTenKhachHang(), trangThai, deciFormat.format(hdht.getTienHoanTra())});
                stt++;
            }
